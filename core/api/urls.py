...
urlpatterns = [
    ...
    path("assets/<slug:asset_id>/inspection/", wachalltag.asset_inspection, name="api_v1_asset_inspection"),
    path("assets/<slug:asset_id>/inspection-schedule/", wachalltag.asset_inspection_schedule, name="api_v1_asset_inspection_schedule"),
    path("assets/<slug:asset_id>/", wachalltag.asset_detail, name="api_v1_asset_detail"),
    path("inspections/due/", wachalltag.inspections_due, name="api_v1_inspections_due"),
